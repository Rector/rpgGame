...
public class GameOverScreen extends AbstractScreen {
    ...
    public void createGui() {
        ...
        final TextButton btnBackToMenu = new TextButton("Back to Menu", gameOverBtnStyle);
        btnBackToMenu.setPosition(Integer.parseInt(props.get("btn_new_game_x")), Integer.parseInt(props.get("btn_new_game_y")));

        TextButton btnExitGame = new TextButton("Exit Game", gameOverBtnStyle);
